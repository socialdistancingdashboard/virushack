...
for file in os.listdir(path):
  if re_sql.match(file):
    ...
    summary_path = os.path.join(os.path.dirname(__file__), "summaries", "data", date_string)
    ...
    client_s3 = boto3.client("s3",
      aws_access_key_id="AKIASVLWJCWHIICIFIWZ", 
      aws_secret_access_key="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", 
