...
def to_data(city_name, lat, lon, traffic_list, passerby_list, noise_list):
    ...
    return {
        ...
        'datetimeRequest': datetime.datetime.now().isoformat(),
        'lat': lat,
        'lon': lon,
        'data': {
...
response = client.put_record(DeliveryStreamName='sdd-kinesis-lemgo-digital',Record={'Data': json.dumps(data_for_S3)})
