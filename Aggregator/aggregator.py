...
s3_client.put_object(Bucket='sdd-s3-basebucket', Key='aggdata/{}/{}/{}/{}'.format(str(date.year).zfill(4), str(date.month).zfill(2), str(date.day).zfill(2), str(x).zfill(2)), Body=json.dumps(dict))
